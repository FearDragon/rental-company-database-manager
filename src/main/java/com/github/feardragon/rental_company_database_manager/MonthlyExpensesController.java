...
public class MonthlyExpensesController implements Initializable {
    ...
    public void getMonthlyExpenses(ActionEvent actionEvent) {
        ...
        if(houseComboBox.getSelectionModel().getSelectedIndex() == 0) {
            try{
                result = expenses.getMonthlyExpense(monthComboBox.getSelectionModel().getSelectedIndex() + 1, Integer.parseInt(yearField.getText()));
        ...
        try{
            result = expenses.getMonthlyExpenseByHouse(monthComboBox.getSelectionModel().getSelectedIndex() + 1, Integer.parseInt(yearField.getText()), houseComboBox.getSelectionModel().getSelectedIndex());
