...
public class YearlyIncomeController implements Initializable {
    ...
    public void getYearlyIncome(ActionEvent actionEvent) {
        ...
        if(houseComboBox.getSelectionModel().getSelectedIndex() == 0) {
            try{
                result = income.getYearlyIncome(Integer.parseInt(yearField.getText()));
        ...
        try{
            result = income.getYearlyIncomeByHouse(Integer.parseInt(yearField.getText()), houseComboBox.getSelectionModel().getSelectedIndex());
